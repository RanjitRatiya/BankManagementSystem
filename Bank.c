/* 
    Bank Management Project Using C Programming
    
 		* For Login Password is : IamYours
 		
 		* To Use Any Account the By Default Account No. is : 1234
 		
	 	* To Use ATM the By Default ATM Pin is : 1234
...
{   int choice;
    system("cls");
    system("color 7");
    printf("\n\n\t\t\t       WELCOME TO AXB BANKING MANAGEMENT SYSTEM");
...
int main()
{
    char IamYours[15],password[15]="IamYours";
    int i=0;
    printf("\n\n\n\t\t\t\t   Welcome To AXB Banking Management System\n\t\t\t\t\t User Login ");
